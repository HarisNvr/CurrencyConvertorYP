...
CELERY_REDIS_DB = 1
CELERY_HOST = getenv('CELERY_HOST')
CELERY_BROKER_URL = f'redis://{CELERY_HOST}:{REDIS_PORT}/{CELERY_REDIS_DB}'
CELERY_RESULT_BACKEND = f'redis://{CELERY_HOST}:{REDIS_PORT}/{CELERY_REDIS_DB}'
